...
def banner():
    print(bcolors.GREEN + "+[+[+  Email-Bomber v1.0.0  ]+]+]+")
    print(bcolors.GREEN + "+[+[+ Made by Robert DeVore ]+]+]+")
    ...
    def __init__(self):
        try:
            ...
            if int(self.mode) > int(4) or int(self.mode) < int(1):
                print("[X] ERROR: Invalid Option. Goodbye...")
                sys.exit(1)
    ...
    def bomb(self):
        try:
            ...
            if self.mode == int(1):
                ...
                self.mode == int(input(bcolors.GREEN + "[+] Enter a custom amount: "))
